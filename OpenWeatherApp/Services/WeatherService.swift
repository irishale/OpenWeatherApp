...
class WeatherService {
    ...
    private func buildUrlComponents(withParams params: [String:String]) -> URLComponents? {
        ...
        if let existingQueryItems: [URLQueryItem] = self.urlComponents?.queryItems {
            queryItems += existingQueryItems
        }
        
        components?.path = kHourlyForecastPath
    ...
    func fetchHourlyForecast(params: [String:String],
        ...
        /*
        var urlComponentsForCurrentForecast = buildUrlComponents(withParams: params)
